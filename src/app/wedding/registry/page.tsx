...
import amazonLogo from "../../../../public/images/wedding/amazon_logo.png"
import amazonImage from "../../../../public/images/wedding/amazon_image.png"
...
const Page: React.FC<PageProps> = ({ responsiveConstraintClasses }) => {
  const crateAndBarrelRegistry = "https://www.crateandbarrel.com/gift-registry/madison-minton/r6752612";
  const amazonRegistry = "https://www.amazon.com/wedding/share/NorsworthyWedding";

  return (
    <main className='min-h-[100vh] flex flex-col items-center w-full overflow-x-hidden'>
      ...
      <div className={[responsiveConstraintClasses, 'flex flex-col items-start'].join(" ")}>
        ...
        <div className="relative flex justify-center w-full p-8 mt-8 h-[400px]">
          <Link
            href={crateAndBarrelRegistry}
            target="_blank"
            rel="noopener noreferrer">
        ...
        <div className="relative flex justify-center w-full p-8 mt-8 h-[400px]">
          <Link
            ...
            target="_blank"
            rel="noopener noreferrer">
            <div className='w-[50vw] h-[50vw] md:w-80 md:h-80 border-solid border-8 absolute rotate-[12deg] z-10 left-[40vw] md:left-[55%] overflow-hidden '>
              <Image
                src={amazonLogo}
            ...
            <div className='w-[50vw] h-[50vw] md:w-80 md:h-80  border-wedding-secondary-shadow border-solid border-8 absolute -rotate-[15deg] z-20 right-[40vw] md:right-[45%] flex justify-center items-center overflow-hidden'>
              <Image
                src={amazonImage}
                alt='picture of brandon and madison'
                placeholder='blur'
                width={400}
                height={400} />
            </div>
